          ...
          field={[
            {
              ...
              value: [
                { key: "CardCode", label: "Customer", size: 4, type: "field" },
            ...
            },
            {
              ...
              value: [
                ...
                { type: "empty", size: 2 },
                { key: "U_WONUM", size: 10, component: (<UISelectField label="WO Number" items={WOList} value={(data as any).U_WONUM} setValue={(v) => { let d = { ...data }; (d as any).U_WONUM = v; setData({ ...d }) }} />) },
                { type: "empty", size: 2 },
            ...
            field={[
              { type: "empty", size: 6 },
              {
                ...
                value: [
                  ...
                  {
                    key:"DiscPrcnt", size: 4, label: "Disc (%)", type:"field"
                  },
                  {
