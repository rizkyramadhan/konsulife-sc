          ...
          <UIJsonField
            ...
            field={[
              ...
              },
              {
                ...
                label: "General",
                value: [
                  { key: "U_IDU_GRPO_INTNUM", type: "field", label: "PO Number", size: 12 },
                  { key: "U_IDU_PO_INTNUM", type: "field", label: "PO Number", size: 12 },
                  { key: "U_IDU_SUP_SONUM", type: "field", label: "SO Number", size: 12 },
                  { key: "I_IDU_DO_INTNUM", type:"field",label: "NO DO Supplier", size: 12 },
                  { key: "DocDate", size: 6, type: "field", label: "Posting Date" },
                  { key: "DocDueDate", size: 6, type: "field", label: "Delivery Date" },
              ...
              },
              {
                key: "optional",
                label: "Optional",
                value: [{ key: "Comments", label: "Remark",type:"field", size: 12 }]
              }
            ]}
